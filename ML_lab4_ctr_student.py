# Databricks notebook source exported at Tue, 4 Aug 2015 05:44:48 UTC
# MAGIC %md
...
logLossTrBase = OHETrainData.map(lambda train: computeLogLoss(classOneFracTrain, train.label)).mean()
